...
<div class="box location">
    <h3><strong><?php _e("Best rated", 'voting') ; ?></strong></h3>
    <ul>
    <?php 
        $count = 0;
        ...
        <li>
            ...
            <?php } ?>
                ...
                <p style="text-align: center;">
                    ...
                    <span style="position:relative; top:-5px;padding-right: 4px; padding-left: 4px; margin-bottom: 3px;"><?php echo $total;?> <?php _e('ratings', 'voting');?></span>
                </p>
            </div>
        </li>
    <?php 
