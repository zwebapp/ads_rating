<?php
    ...
    class AR extends DAO
    {
        ...
        public function uninstall()
        {
            ...
            $this->dao->query("DROP TABLE ".DB_TABLE_PREFIX."t_rated_items");
            $this->dao->query("DROP TABLE ".DB_TABLE_PREFIX."t_dev");
        ...
        {
            $sql  = 'SELECT i_user_voted as user_id, format(avg(i_value),1) as avg_vote, count(*) as num_votes ';
